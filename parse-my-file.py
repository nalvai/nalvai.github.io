          ...
          <title>Nalvai's Assortment of Lojban Vocabulary Attestation Instances</title>
            ...
            <body>
              <h1>NALVAI <span style="color: red;">(DEMO)</span></h1>
                ...
                <p>In this word list, a word with a fully filled background means that it currently has an entry in NALVAI. A word with only a border means that it has not yet been included, although I intend to include it. I work on this project mostly by myself and I create each entry manually, so progress is slow.</p>
    '''
    print(head, file=f)
